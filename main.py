...
flags = tf.app.flags
flags.DEFINE_integer(flag_name='epoch', default_value=1, docstring='number of epochs')
flags.DEFINE_string(flag_name='size_batch', default_value=50, docstring='size of one batch')
...
flags.DEFINE_string(flag_name='dataset', default_value='CACD', docstring='dataset name')
