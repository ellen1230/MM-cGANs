...
flags.DEFINE_string(flag_name='loss_weights', default_value=[0, 1, 1, 1, 450],
...
flags.DEFINE_string(flag_name='num_D_img_loss', default_value=0, docstring='D_img_loss training number')
